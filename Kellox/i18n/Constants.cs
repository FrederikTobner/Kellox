...
internal static class Constants
{
    ...
    public const string ClearFunction = "clear";
    public const string ClockFunction = "clock";
    public const string RandomFunction = "random";
    public const string ReadFunction = "read";
    public const string WaitFunction = "wait";
