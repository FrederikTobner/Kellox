...
internal static class LoxInterpreter
{
    ...
    {
        loxEnvironment.Define(Constants.ClockFunctionMessage, new ClockFunction());
        loxEnvironment.Define(Constants.WaitFunctionMessage, new WaitFunction());
        loxEnvironment.Define(Constants.ClearFunctionMessage, new ClearFunction());
        loxEnvironment.Define(Constants.ReadFunctionMessage, new ReadFunction());
        loxEnvironment.Define(Constants.RandomFunctionMessage, new RandomFunction());
    }
